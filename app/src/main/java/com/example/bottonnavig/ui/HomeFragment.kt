...
import com.example.bottonnavig.BuildConfig
import com.example.bottonnavig.MainActivity
...
class HomeFragment : Fragment() {
    ...
    private lateinit var homeViewModel: HomeView
    ...
    override fun onCreateView(
        ...
        homeViewModel =
            ViewModelProviders.of(this).get(HomeView::class.java)
